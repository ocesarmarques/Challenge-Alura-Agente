...
[32m[32m[1m34 passed[0m, [33m1 skipped[0m[32m in 0.23s[0m[0m
...
A publicação final depende da execução do script no computador do usuário,
onde estão disponíveis Git, autenticação GitHub e os arquivos locais.
